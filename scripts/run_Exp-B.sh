#!/bin/bash
# Exp-B: Token Doubling (2000 genes, 4000 peaks)
# Purpose: Test if longer token sequences improve performance with compression
...
python -m torch.distributed.run \
    ...
    --nnodes=1 \
    run_token1_test.py \
    --experiment_name "Exp-B_token_doubling" \
